...
export async function getFearGreedIndex(): Promise<FearGreedData> {
  ...
  if (!item) throw new Error("Fear & Greed API returned empty data");
  return {
...
// ─────────────────────────────────────────────────────
// CryptoCompare News (free, no API key required)
// ─────────────────────────────────────────────────────
...
export interface NewsItem {
  ...
  source: string;
  publishedAt: string;
  currencies?: string[]; // Related coins, e.g. ["BTC", "ETH"]
  categories?: string; // e.g. "MARKET|REGULATION|BTC"
  important?: boolean; // Whether determined as important news
}
...
// ─────────────────────────────────────────────────────
// Price Movement Detection (1-hour price change)
// ─────────────────────────────────────────────────────
