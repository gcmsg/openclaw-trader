...
## 🤖 Testnet 自主操作授权（2026-02-26 主人授权，2026-03-01 更新）

**Testnet 账户的所有操作无需主人授权，执行后报告即可。**

包括但不限于：
- 自主决策入场、出场、调仓（含做多 **和做空**）
- 修改 testnet 策略配置和参数
- 启动/停止 testnet 相关服务

**做空授权（2026-03-01）：**
- Testnet 范围内可自主开空单、平空单
- 空单同样遵守风控：单笔止损 5%，总亏损 20% 自动暂停
- 每次开/平空单后 Telegram 通知主人

汇报规则：
- 每次开仓/平仓/重要操作后 Telegram 通知主人
